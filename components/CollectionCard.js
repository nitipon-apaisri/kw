            ...
            <div className="w-full h-64 rounded-2xl">
                ...
                >
                    <div className=" absolute top-1/2 left-1/2" style={{ transform: "translate(-50%, 10%)" }}>
                        <div className="bg-center bg-cover border-8 border-white w-24 h-24 rounded-full shadow-xl mb-2 bg-pink" style={{ backgroundImage: `url(${values.media.profile})` }}></div>
                    </div>
                </div>
                <div className="text-center mt-14">
                    <h3 className="font-bold tracking-wider">{values.title}</h3>
                </div>
            </div>
        </div>
    );
